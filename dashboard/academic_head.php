...
|--------------------------------------------------------------------------
|
| The navbar reads the currently active School Year from the
| existing school_years table.
|
*/
...
try {
    ...
    error_log(
        '[APRISM Academic Head Dashboard - Active School Year] ' .
        $e->getMessage()
    );
...
/*
|--------------------------------------------------------------------------
| Existing Dashboard Academic Period
|--------------------------------------------------------------------------
|
| Kept unchanged for now.
| The current task is only the shared top-navbar.
|
*/

$dashboardSchoolYear = '2025–2026';
            ...
            <article class="dashboard-widget">
                ...
                <header class="dashboard-widget-header">
                    ...
                    <div class="widget-title-group">
                        ...
                        <i data-lucide="trending-up" class="widget-header-icon">
                        </i>
            ...
            <article class="dashboard-widget">
                ...
                <header class="dashboard-widget-header">
                    ...
                    <div class="widget-title-group">
                        ...
                        <i data-lucide="alert-triangle" class="widget-header-icon text-warning">
                        </i>
            ...
            <article class="dashboard-widget">
                ...
                <header class="dashboard-widget-header">
                    ...
                    <div class="widget-title-group">
                        ...
                        <i data-lucide="pie-chart" class="widget-header-icon text-info">
                        </i>
                            ...
                            <tr class="dashboard-table-empty-row">
                                ...
                                <td colspan="4" class="dashboard-table-empty">
                                    ...
                                    <div class="dashboard-table-empty-content">
                                        ...
                                        <h3>
                                            No Academic Analytics Available
                                        </h3>

                                        <p>
                                            Academic analytics will automatically
                                            appear once attendance, grading, and
                                            monitoring modules begin collecting data.
                                        </p>
